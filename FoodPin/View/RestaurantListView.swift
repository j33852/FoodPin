...
struct RestaurantListView: View {
    ...
    //宣告是否show導覽頁的狀態變數
    @State private var showWalkThrought = true
    
    //@AppStorage專用屬性包裹器, 可以類似userDefaults來做資料存取
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showWalkThrought) {
            TutorialView()
        }
        .onAppear {
            showWalkThrought = hasViewedWalkthrough ? false : true
        }
    }
    ...
    var body: some View {
        ...
        .contextMenu {
            ...
            Button(action: {
                ...
                HStack {
                    Text(restaurant.isFavorite ? "移除最愛" : "我的最愛")
        ...
        .alert(isPresented: $showError) {
            Alert(title: Text("功能尚未建置"),
                  message: Text("抱歉此功能尚未完成，請稍後再嘗試"),
